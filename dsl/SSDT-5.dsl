 ...
 *
 * Disassembly of /Users/matt/Builds/Asus-Q501LA-Hackintosh/EFI/CLOVER/ACPI/origin/SSDT-5.aml, Thu Dec 28 23:20:17 2017
 *
        ...
        Device (IAOE)
        {
            ...
            Method (SAOS, 1, NotSerialized)
            {
                ...
                If (And (\_SB.PCI0.GFX0.TCHE, 0x0100))
                {
                    If (LEqual (ITMR, One))
                    {
                        If (LAnd (LAnd (And (IBT1, One), LOr (And (\_SB.IAOE.WKRS, 0x02), And (\_SB.IAOE.WKRS, 0x10))), LNot (And (Arg0, One))))
                        {
                    ...
                    ElseIf (LAnd (LAnd (And (IBT1, One), LOr (And (\_SB.IAOE.WKRS, 0x02), And (\_SB.IAOE.WKRS, 0x10))), LNot (And (Arg0, One))))
                    {
                        If (LNot (\_SB.PCI0.GFX0.PARD ()))
                        {
                            Store (And (\_SB.PCI0.GFX0.STAT, 0xFFFFFFFC), \_SB.PCI0.GFX0.STAT)
